...
function preload(){
 // backgroundImg= loadImage("solarImages/galaxy.png");
  sunImg=loadImage("pics/sun.jpg");
  mercuryImg=loadImage("pics/mercury.jpg");
  venusImg=loadImage("pics/v.jpg");
  earthImg=loadImage("pics/e.jpg");
...
function setup() {
  ...
  sun = createSprite(600,400, 200, 200);
  sun.addImage(sunImg);
  sun.scale= 0.1;
  //console.log(sun.x);
  ...
  venus.scale= 0.15;
  earth = createSprite(1000,200,40,40);
